...
**多租户按客户数倍乘**：1–3 家客户 = 1.3–4.0 QPS，所需模型并发度 **约 7–20**
〔2026-08-25 按实测重算；此前写的 20–60 基于"单请求占用模型 15s"这个从旧 P50 反推的假设，
该假设已作废。完整推导见 `docs/scale_slo_and_priorities.md` §1.1.1 与 §5.1〕。
